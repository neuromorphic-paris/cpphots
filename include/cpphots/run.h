 ...
 */
Events train(Network& network, Events training_events, const ClustererInitializerType& initializer, bool skip_check = false);
 ...
 * @return events generated by the last layer of the network
 */
std::vector<Events> train(Network& network, std::vector<Events> training_events, const ClustererInitializerType& initializer, bool use_all = true, bool skip_check = false);
